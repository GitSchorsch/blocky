...
You can enable the logging of DNS queries (question, answer, client, duration etc) to a daily CSV file (can be opened in
Excel or OpenOffice Calc) or MySQL/MariaDB database.
